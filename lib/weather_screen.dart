            ...
            FutureBuilder(
              ...
              builder: (context, snapshot) {
                ...
                final currentPressure =
                    currentWeather['main']['pressure']?.toString() ?? 'N/A';
                final currentWindSpeed =
                    currentWeather['wind']['speed']?.toString() ?? 'N/A';
                final currentHumidity =
                    currentWeather['main']['humidity']?.toString() ?? 'N/A';
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final hourlySky =
                              hourlyForecast['weather'][0]['main'] ?? 'Unknown';
                          final hourlyTemp =
                              hourlyForecast['main']['temp']?.toDouble() ?? 0.0;
